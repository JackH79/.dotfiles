...
clockwidget = widget({ type = "textbox" })
	vicious.register(clockwidget, fuzzyclock, "" .. colbblk .. " at " .. coldef .. colbyel .. "$1 $2" .. coldef .. "")
	require("remind")
	clockwidget:add_signal('mouse::enter', function () cal_remt = { naughty.notify({ text = cal_gett(), icon="/home/jack/bin/todos.png", border_color = "" .. blk .. "", timeout = 0 }) } end)
